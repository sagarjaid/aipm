export const tickets = [
    {
      ...
      status: 'OPEN',
      summary: 'BUGFIX',
      description: 'General bug fixes and improvements for the current sprint. This includes various minor issues that need to be addressed across the application.',
    ...
    },
    {
      ...
      description: 'Implement a new workflow builder interface for the PLD module. This epic includes designing and developing a drag-and-drop interface for creating custom workflows.',
    ...
    },
    {
      ...
      description: 'Complete product review for versions RV2.75.1 and RV2.75.2. This includes testing all new features and ensuring quality standards are met before release.',
    ...
    },
    {
      ...
      description: 'Ongoing DevOps tasks including infrastructure improvements, deployment pipeline optimization, and monitoring setup.',
    ...
    },
    {
      ...
      description: 'Track and manage agile development efforts for the ATRE team. This includes sprint planning, retrospectives, and process improvements.',
    ...
    },
    {
      ...
      description: 'Quality assurance activities including test case creation, automated testing, and bug verification for the current release cycle.',
    ...
    },
    {
      ...
      status: 'OPEN',
      summary: 'HOTFIX',
      description: 'Critical bug fix required for production environment. This is a high-priority issue that needs immediate attention.',
    ...
    },
    {
      ...
      description: 'Implement analytics tracking for the PLD module. This includes setting up event tracking, dashboards, and reporting capabilities.',
    ...
    },
    {
      ...
      status: 'OPEN',
      summary: 'RV2.75.2',
      description: 'Release version 2.75.2 preparation and deployment. This includes final testing, documentation updates, and release notes preparation.',
    ...
    },
    {
      ...
      status: 'OPEN',
      summary: 'RV2.76',
      description: 'Subtask for RV2.76 release preparation. This includes specific components that need to be completed as part of the larger release.',
    ...
    },
    {
      ...
      status: 'OPEN',
      summary: 'V2 - RV2.75.1',
      description: 'Version 2 implementation for RV2.75.1. This includes new features and improvements that are part of the version 2 roadmap.',
    ...
    },
    {
      ...
      priority: 'Highest',
      status: 'Done',
      summary: '[HOTFIX][RV2.75.1] The first promoter API for the lead may be called twice',
