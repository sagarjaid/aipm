      ...
      <div className='flex items-center gap-4 flex-wrap'>
        ...
        <Popover>
          ...
          <PopoverContent className='w-64 p-0'>
            <div className='p-4'>
              <h4 className='font-medium text-sm mb-3'>Assignees</h4>
        ...
        <Popover>
          ...
          <PopoverContent className='w-64 p-0'>
            <div className='p-4'>
              <h4 className='font-medium text-sm mb-3'>Issue Types</h4>
              <div className='space-y-2 max-h-64 overflow-y-auto'>
        ...
        <Popover>
          ...
          <PopoverContent className='w-64 p-0'>
            <div className='p-4'>
              <h4 className='font-medium text-sm mb-3'>Statuses</h4>
              <div className='space-y-2 max-h-64 overflow-y-auto'>
        ...
        {getUniqueValues('label').length > 0 && (
          <Popover>
            ...
            <PopoverContent className='w-64 p-0'>
              <div className='p-4'>
                <h4 className='font-medium text-sm mb-3'>Labels</h4>
                <div className='space-y-2 max-h-64 overflow-y-auto'>
        ...
        {getUniqueValues('fixVersion').length > 0 && (
          <Popover>
            ...
            <PopoverContent className='w-64 p-0'>
              <div className='p-4'>
                <h4 className='font-medium text-sm mb-3'>Fix Versions</h4>
                <div className='space-y-2 max-h-64 overflow-y-auto'>
                  {issues
                    .flatMap((i) => i.fields.fixVersions || [])
                    .filter(
        ...
        {/* View Toggle */}
        <div className='flex bg-white border rounded-lg p-1 ml-auto'>
          <Button
