    ...
    <>
      {pathName.endsWith("/") ? (
        <a
          ...
          } group btn-block rounded-sm`}
        >
          {isLoading ? (
            <span className="loading loading-spinner loading-xs"></span>
          ) : (
            <svg
              className="h-5 w-5 transition-transform duration-200 group-hover:-rotate-3 group-hover:scale-110"
              viewBox="0 0 375 509"
        ...
        <button
          className="group btn btn-block rounded-sm bg-green-300 text-black hover:bg-green-400 disabled:bg-green-400 disabled:text-black"
