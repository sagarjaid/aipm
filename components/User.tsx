    ...
    <>
      <div className="overflow-hidden bg-base-100 p-1">
        <div className="space-y-2 text-sm">
          <div className="flex w-full flex-col gap-2 rounded-lg p-2 font-medium">
          ...
          <button
            className="flex w-full items-center gap-2 rounded-md p-1.5 font-medium duration-200 hover:bg-error/20 hover:text-error"
