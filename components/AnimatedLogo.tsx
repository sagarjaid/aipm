    ...
    >
      <div className="relative h-7 w-7">
        <svg
          ...
          className="h-full w-full transition-all duration-1000 ease-in-out group-hover:translate-x-[2.5rem]"
          style={{
            fill: "black",
            color: "rgb(51, 51, 51)",
          }}
      ...
      <p className="text-3xl font-bold text-black transition-all duration-1000 ease-in-out group-hover:translate-x-[-20%] group-hover:opacity-0">
        aipm
      </p>
    </Link>
  );
