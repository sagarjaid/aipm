const Arrow = ({ extraStyle }: { extraStyle: string }) => {
  return (
    <svg
      className={`w-12 shrink-0 opacity-70 ${extraStyle}`}
      viewBox="0 0 138 138"
      fill="black"
...
const Problem = () => {
  // return (
  //   <section className='border rounded-md bg-gradient-to-t from-white via-blue-100 to-white'>
  ...
  return (
    <section className=" ">
      <div className="mx-auto max-w-7xl px-8 py-16 text-center md:py-32">
        <h2 className="mx-auto mb-6 max-w-3xl text-4xl font-extrabold leading-10 tracking-tight md:mb-8 md:text-5xl">
        ...
        <div className="flex flex-col items-center justify-center gap-6 md:flex-row md:items-start">
          <Step emoji="🤚" text="Create a Goal" />

          <Arrow extraStyle="max-md:-scale-x-100 md:-rotate-90 text-blue-200" />

          <Step emoji="😍" text="Get reminder calls" />

          <Arrow extraStyle="md:-scale-x-100 md:-rotate-90" />

          <Step emoji="💪" text="Stay on Track" />
        </div>
      </div>
    </section>
  );
