...
const Navbar = () => {
  ...
  return (
    <div className="hidden w-[300px] cursor-pointer flex-col justify-between border-r p-4 lg:flex">
        ...
        {fillters.map((el, i) => {
          ...
          return (
            <Link
              ...
              className={
                isActive
                  ? "flex gap-2 rounded-lg bg-gray-100 p-1.5 hover:bg-gray-200"
                  : "flex gap-2 rounded-lg bg-white p-1.5 hover:bg-gray-100"
              }
      ...
      <div className="pb-10">
        ...
        <div className="mb-10 flex flex-col items-start justify-center gap-2.5 text-xs">
