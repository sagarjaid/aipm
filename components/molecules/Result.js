...
const Result = ({ interviewId }) => {
  ...
  const message =
    "Hey, I found this AI-powered F1 visa interview tool that takes mock interview, I used it and got my F1 visa approved in the test > https://getaipm.com/";
  ...
  return (
    <div className="flex h-full w-full cursor-pointer items-center justify-between gap-2 rounded-md border shadow-md hover:shadow-lg">
      {loading ? (
        <div className="flex h-[630px] w-full items-center justify-center">
        ...
        <div className="flex w-full flex-col gap-6">
          <div className="flex flex-col gap-0.5 px-4 pt-4">
            ...
            <div className="mt-4 text-lg font-semibold">Interview Result</div>
            <div className="text-xs text-gray-700">
              InterviewID : {interviewId}
            </div>
          </div>
          <div className="flex flex-col gap-1 border-b px-4 pb-6">
            {result?.visaStatus ? (
          ...
          <div className="flex flex-col p-2 pl-4 pt-0">
            ...
            <div className="flex flex-col gap-4 p-2 pt-4 text-xs">
              {reasons?.length > 0 ? (
                reasons.map((el, i) => (
                  <div key={i}>
          ...
          <div className="flex justify-start gap-5 px-4 pb-6 text-xs">
            {result?.visaStatus ? (
              <a
                href={`https://wa.me/?text=${encodeURIComponent(message)}`}
                target="_blank"
                className="flex cursor-pointer items-center gap-2 rounded-md border border-black bg-white p-2 px-3.5 hover:bg-slate-50"
              >
                <svg
                  className="h-5 w-5"
                  fill="none"
