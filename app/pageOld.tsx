      ...
      <main className='mx-auto flex w-full max-w-5xl flex-col items-center justify-start overflow-hidden bg-[url("/bg.svg")]'>
        ...
        <div className="flex w-full flex-col items-center justify-center">
          <div className="flex w-full max-w-5xl flex-col items-center justify-center gap-8 px-4 pt-20">
            ...
            <div className="flex max-w-4xl flex-wrap gap-2 text-center text-2xl font-extrabold leading-6 xs:text-3xl mdx:text-5xl">
              {/* A True <span className='font-bold'>AI Scrum Master at 10X the cost of a Scrum Master</span> */}
              Save $80K/Year: Replace Your Scrum Master with AI — at 100X Less
              Cost
              {/* and{' '} */}
