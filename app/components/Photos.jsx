...
export default function Photos() {
  return (
    <div className='min-h-screen w-full bg-white p-8 mt-20 lg:mt-2 mb-20 flex items-center justify-center'>
      <div className='max-w-5xl w-full relative'>
        ...
        <div className='relative w-full h-[500px]'>
          ...
          {/* Y Combinator office */}
          <div className='absolute left-[40%] top-[60px] w-[220px] border rounded-lg bg-white p-2 shadow-lg transform rotate-[14deg] z-10'>
          ...
          <div className='absolute right-[5%] top-[10px] w-[300px] border rounded-lg bg-white p-3 shadow-md transform rotate-[2deg] z-20'>
        ...
        {/* Bottom row */}
        <div className='relative w-full h-[400px] mt-[-60px]'>
          {/* Our friend Bisco */}
