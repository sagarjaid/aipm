        ...
        <div className="flex flex-col items-center w-full justify-center ">
          <div className="flex max-w-5xl w-full gap-8 flex-col items-center justify-center px-4 pt-20">
            <div className="flex flex-col items-center justify-center gap-10 ">
              <div className="text-lg font-extrabold border border-black rounded-full px-4 py-2">
                Save $80K/Year!
              </div>
            ...
            <div
              id="try-it"
              className="flex flex-row items-start justify-center pt-6 space-x-0.5"
            >
              <p className="text-xl font-bold text-green-600 animate-wiggle">
                Daily Stand-up is live, Try it
              </p>
              <svg
                viewBox="0 0 68 77"
                xmlns="http://www.w3.org/2000/svg"
                className="w-10 h-12 fill-current -scale-x-100 pt-3 text-primary"
              >
                <path
                  fillRule="evenodd"
                  clipRule="evenodd"
