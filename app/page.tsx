    ...
    <>
      <main className='mx-auto flex w-full max-w-5xl flex-col items-center justify-start overflow-hidden bg-[url("/bg.svg")]'>
        ...
        <div className="flex w-full flex-col items-center justify-center">
          <div className="flex w-full max-w-5xl flex-col items-center justify-center gap-8 px-4 pt-20">
            <div className="flex w-full flex-col items-center justify-center gap-10">
              <div className="rounded-full border border-black px-4 py-2 text-lg font-extrabold">
                Save $80K/Year!
              </div>
              <div className="flex max-w-4xl flex-wrap gap-4 bg-gradient-to-t from-white via-green-50 to-white text-center text-2xl font-extrabold leading-10 xs:text-3xl mdx:text-5xl">
                Replace Your Scrum Master with Vertical AI Scrum Master Agent
              </div>
            </div>
            <div className="max-w-lg text-center text-xs xs:text-xs mdx:text-sm">
            ...
            <div
              id="try-it"
              className="flex flex-row items-start justify-center space-x-0.5 pt-6"
            >
              <p className="animate-wiggle text-xl font-bold text-green-600">
                Daily Stand-up is live, Try it
              </p>
              <svg
                viewBox="0 0 68 77"
                xmlns="http://www.w3.org/2000/svg"
                className="h-12 w-10 -scale-x-100 fill-current pt-3 text-primary"
              >
                <path
                  fillRule="evenodd"
                  clipRule="evenodd"
            ...
            <div className="text-center text-xs">
              10+ teams are already using AIPM to run the daily standup
            </div>
          </div>
        </div>
        ...
        <div
          id="products"
          className="flex flex-col items-center justify-center gap-10 p-4 pt-40"
        >
        ...
        <div className="mt-20 flex w-full flex-col items-center justify-center gap-20 p-4 md:my-36">
        ...
        <div className="my-28 flex w-full flex-col items-center justify-center gap-4 p-4 md:mt-0">
          <div className="top-32 flex flex-col items-center justify-center gap-2 text-center md:relative">
            <h2 className="text-3xl font-extrabold xs:text-4xl mdx:text-6xl">
              Making Today
            </h2>
